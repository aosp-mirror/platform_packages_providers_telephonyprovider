...
public class RcsProvider extends ContentProvider {
    ...
    // These are the same database, but the writable one locks the database while in use.
    ...
    public boolean onCreate() {
        ...
        SQLiteOpenHelper openHelper = MmsSmsDatabaseHelper.getInstanceForCe(getContext());
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        return qb.query(
                mReadableDatabase, projection, selection, selectionArgs, null, null, sortOrder);
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (match) {
            case THREAD:
                mWritableDatabase.insert(THREAD_TABLE, ID, values);
                break;
            default:
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case THREAD:
                deletedCount = mWritableDatabase.delete(THREAD_TABLE, selection, selectionArgs);
                break;
            default:
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case THREAD:
                updatedCount = mWritableDatabase.update(
